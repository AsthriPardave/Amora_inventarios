/**
 * Configuración de Ubigeo - Departamentos, Provincias y Distritos del Perú
 * Incluye todos los departamentos y distritos completos de Lima Metropolitana
 */
...
const UBIGEO_PERU = {
    ...
    "Huancavelica": {
        "Huancavelica": ["Huancavelica", "Acobambilla", "Acoria", "Conayca", "Cuenca", "Huachocolpa", "Huayllahuara", "Izcuchaca", "Laria", "Manta", "Mariscal Cáceres", "Moya", "Nuevo Occoro", "Palca", "Pilchaca", "Vilca", "Yauli", "Ascensión", "Huando", "Huaylacucho"],
